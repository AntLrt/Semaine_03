...
--
-- Hôte : 127.0.0.1:3306
-- Généré le : mar. 02 fév. 2021 à 09:51
...
CREATE TABLE IF NOT EXISTS `employees` (
  ...
  `emp_children` tinyint(4) NOT NULL,
  PRIMARY KEY (`emp_id`),
...
(1, 17, 5, 'MOLETTE', 'Denis', '27 avenue Paul Lepoulpe', '80000', 'Amiens', 'dmolette@blabla.fr', 102030405, 18473, '2020-05-05', 'M', 1),
(2, 3, 2, 'NAGER', 'Emma', '14 rue Tabaga', '80300', 'Albert', 'emmanager@laposte.net', 102030405, 39576, '2015-03-27', 'F', 0),
(3, 0, 1, 'LEBOSSE', 'Hugo', '28 mail Ludovic Cruchot', '75001', 'Paris', 'leboss@jarditou.com', 102030405, 350001, '2000-01-01', 'M', 2),
...
(11, 26, 27, 'POUTIN', 'Vladimir', '251-633 Convallis Impasse', '8373 ', 'Colchester', 'facilisis.vitae.orci@indolor.net', 102030405, 29500, '2015-05-03', 'M', 1);
...
(1, '2008-08-20', '2018-12-01', '2019-08-29', '2000-04-17', 'Preparation', 19),
(2, '2016-01-22', '2011-02-02', '2013-04-13', '2004-10-29', 'Commande urgente', 67),
(3, '2019-12-25', '2000-03-28', '2009-08-04', '2021-03-24', 'Preparation', 85),
(4, '2016-08-18', '2004-02-06', '2014-12-29', '2008-07-26', 'Commande urgente', 88),
(5, '2009-06-19', '2012-10-07', '2017-08-30', '2010-09-20', 'Preparation', 27),
(6, '2012-08-18', '2006-09-05', '2018-02-08', '2001-05-04', 'Transit', 95),
(7, '2010-09-01', '2016-02-02', '2006-11-24', '2016-10-19', 'Transit', 78),
(8, '2021-04-01', '2016-02-05', '2004-08-13', '2016-01-07', 'Preparation', 34),
(9, '2012-08-14', '2013-01-28', '2009-07-29', '2003-07-31', 'Preparation', 51),
(10, '2014-06-19', '2005-09-12', '2016-09-04', '2002-05-21', 'Commande urgente', 28),
(11, '2015-09-21', '2012-09-08', '2003-04-21', '2019-05-31', 'Preparation', 59),
(12, '2008-05-02', '2001-01-10', '2006-02-26', '2002-10-22', 'Transit', 36),
(13, '2005-08-19', '2014-06-17', '2020-06-14', '2000-07-13', 'Transit', 96),
(14, '2016-05-16', '2020-12-10', '2009-06-23', '2006-10-04', 'Preparation', 79),
(15, '2007-06-03', '2014-11-21', '2012-07-09', '2001-07-09', 'Transit', 56),
(16, '2019-06-14', '2000-07-30', '2014-05-16', '2006-03-01', 'Commande annulée', 81),
(17, '2020-07-13', '2008-10-12', '2014-06-10', '2005-01-27', 'Preparation', 34),
(19, '2021-01-12', '2009-05-28', '2004-07-02', '2010-11-02', 'Preparation', 98),
(20, '2000-08-15', '2017-01-06', '2020-06-17', '2016-02-24', 'Preparation', 1),
...
(23, '2002-11-13', '2011-08-24', '2000-03-24', '2013-11-03', 'Preparation', 34),
(24, '2004-04-06', '2016-01-12', '2018-04-16', '2013-04-22', 'Preparation', 38),
(25, '2020-05-07', '2013-03-20', '2001-08-08', '2007-03-26', 'Commande annulée', 30),
(26, '2009-03-20', '2010-02-06', '2002-02-18', '2009-10-27', 'Preparation', 90),
(27, '2012-09-18', '2014-06-12', '2017-11-22', '2018-06-06', 'Transit', 9),
(28, '2006-11-03', '2005-05-28', '2012-12-09', '2020-07-29', 'Transit', 1),
(29, '2010-06-25', '2000-08-18', '2001-04-25', '2005-03-07', 'Transit', 24),
(30, '2006-10-23', '2012-07-19', '2009-07-18', '2009-08-25', 'Transit', 67);
...
CREATE TABLE IF NOT EXISTS `posts` (
  ...
  `pos_libelle` varchar(70) NOT NULL,
  PRIMARY KEY (`pos_id`)
